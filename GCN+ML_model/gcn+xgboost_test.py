...
GCN_model.load_state_dict(torch.load('epoch_28_model.pth'))

XG_model = xgb.Booster(model_file='epoch_28_xgb.model')
...
for i_batch, batch in enumerate(test_dataloader):
    ...
    XG_test_x = xgb.DMatrix(XG_test_x)
    pre = XG_model.predict(XG_test_x)
